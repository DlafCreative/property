...
// @tnn : created this definition manually to be able to use Materialize functions. The current @types/materialize-css download
// @type/jquery dependency and @types/pickadate which also itself download @types/jquery, leading to duplicate identifiers issues.
